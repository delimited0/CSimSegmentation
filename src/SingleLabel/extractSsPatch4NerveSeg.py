...
parser.add_argument("--basePath", default="/Users/kushaagragoyal/Desktop/Independent Study/nerveSeg/", type=str, help="base path for this project's data")
parser.add_argument("--dataFolder", default="testData/Data/", type=str, help="the name of the data source folder")
parser.add_argument("--labelFolder", default="testData/Labels/", type=str, help="the name of the label source folder")
parser.add_argument("--save2Folder", default="nerveh/test/", type=str, help="the name of the save2folder")
...
#     print allfilenames
    ...
    for i_file, filename in enumerate(allfilenames):
        ...
        labelfilename = filename[0:len(filename)-7]+' FN.nii.gz'
        print labelfilename

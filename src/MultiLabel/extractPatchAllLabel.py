...
parser.add_argument("--basePath", default="/Users/kushaagragoyal/Desktop/Independent Study/AllLabelData/Specimen2501L/", type=str, help="base path for this project's data")
parser.add_argument("--dataFolder", default="Data/", type=str, help="the name of the data source folder")
parser.add_argument("--labelFolder", default="Label/", type=str, help="the name of the label source folder")
parser.add_argument("--save2Folder", default="test/", type=str, help="the name of the save2folder")
...
def main():
    ...
    for i_file, filename in enumerate(allfilenames):
        ...
        labelfilename = filename[0:len(filename)-7]+'.nrrd'
        print labelfilename
        ...
        labelimg, _ = nrrd.read(labelfn)
        labelimg = np.transpose(labelimg,[2,0,1]) # can be [2,1,0] also
#         if ind<14:
